...
the Pawn language, consult the document "The Pawn booklet: The Language".
If you installed Pawn via the Setup utility (for Microsoft Windows), you
...
"srun" is a program that is mostly developed in the Pawn manual to show you
what you should do at a minimum to embed Pawn into a program.
...
Pawn compiler in the process. Greg Garner also wrote (and contributed) the
...
new features in the Pawn toolkit.
