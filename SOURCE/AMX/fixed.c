 ...
 *
 *  Version: $Id: fixed.c 3363 2005-07-23 09:03:29Z thiadmer $
 */
#include <assert.h>
#include <ctype.h>
...
static cell AMX_NATIVE_CALL n_fixed(AMX *amx,cell *params)
{
  (void)amx;
  return params[1] * MULTIPLIER;
}

static cell AMX_NATIVE_CALL n_fixedstr(AMX *amx,cell *params)
{
  char str[50],*ptr;
...
static cell AMX_NATIVE_CALL n_fmul(AMX *amx,cell *params)
{
#if !USE_ANSI_C
...
static cell AMX_NATIVE_CALL n_fdiv(AMX *amx,cell *params)
{
#if !USE_ANSI_C
#if defined __WATCOMC__ && defined __386__
...
static cell AMX_NATIVE_CALL n_fmuldiv(AMX *amx,cell *params)
{
#if !USE_ANSI_C
#if defined __WATCOMC__ && defined __386__
...
static cell AMX_NATIVE_CALL n_ffract(AMX *amx,cell *params)
{
  (void)amx;
  return params[1] % MULTIPLIER;
}

static cell AMX_NATIVE_CALL n_fround(AMX *amx,cell *params)
{
  cell value;
...
static cell AMX_NATIVE_CALL n_fsqroot(AMX *amx,cell *params)
{
  cell value=params[1];
  cell low=0;
  cell high=value;
 ...
 */
static cell AMX_NATIVE_CALL n_fpower(AMX *amx,cell *params)
{
 ...
 */
static cell AMX_NATIVE_CALL n_fabs(AMX *amx,cell *params)
{
