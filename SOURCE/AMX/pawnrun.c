 ...
 *
 *  Version: $Id: pawnrun.c 3363 2005-07-23 09:03:29Z thiadmer $
 */
#include <assert.h>
#include <stdio.h>
#include <stdlib.h>
...
int main(int argc,char *argv[])
{
   ...
   * module, for example).
   */
  err = amx_GetUserData(&amx, AMX_USERTAG('I','d','l','e'), (void**)&idlefunc);
  if (err == AMX_ERR_NONE && idlefunc != NULL) {
    while (idlefunc(&amx) == AMX_ERR_NONE)
      /* nothing */;
    ExitOnError(&amx, err);
  } /* if */
