 ...
 *
 *  Version: $Id: termwin.c 3363 2005-07-23 09:03:29Z thiadmer $
 */
                   ...
                   DWORD style)
{
  ...
  con->attrib=0x07;             /* light-gray on black */
  con->autowrap=TRUE;
  ...
  con->hwnd=CreateWindow(__T("TermWin:Console"),__T("Pawn console"),style|WS_VISIBLE,
